    ...
    <div class="header-top">
        <div class="regionality">
            ...
            <div class="regionality-cities">
                <a class="city" href="#">Челябинск</a>
                <img src="/images/header/arrow-icon.svg" alt="arrow-icon">
            </div>
        </div>
        ...
        <div class="request-call">
            ...
            <a href="#" class="request-call__link">Заказать звонок</a>
        </div>
        <div class="line-block">
            <div class="language-selection">
                <img src="/images/header/lang-icon.svg" alt="">
            ...
            <a href="#" class="profile">
                <img src="/images/header/profile-icon.svg" alt="">
            </a>
            <a href="#" id="cart">
